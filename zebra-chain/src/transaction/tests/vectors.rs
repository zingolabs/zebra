...
fn fake_v5_round_trip() {
    ...
    fake_v5_round_trip_for_network(Network::public_testnet());
}
...
fn fake_v5_librustzcash_round_trip() {
    ...
    fake_v5_librustzcash_round_trip_for_network(Network::public_testnet());
}
...
fn binding_signatures() {
    ...
    binding_signatures_for_network(Network::public_testnet());
}
