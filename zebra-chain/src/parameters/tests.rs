...
fn activation_bijective() {
    ...
    let testnet_activations = Network::public_testnet().activation_list();
...
fn activation_extremes_testnet() {
    let _init_guard = zebra_test::init();
    activation_extremes(Network::public_testnet())
}
...
fn activation_consistent_testnet() {
    let _init_guard = zebra_test::init();
    activation_consistent(Network::public_testnet())
}
...
fn branch_id_extremes_testnet() {
    let _init_guard = zebra_test::init();
    branch_id_extremes(Network::public_testnet())
}
...
fn branch_id_consistent_testnet() {
    let _init_guard = zebra_test::init();
    branch_id_consistent(Network::public_testnet())
}
