...
fn difficulty_is_valid_for_historical_blocks() -> Result<(), Report> {
    ...
    difficulty_is_valid_for_network(Network::public_testnet())?;
...
fn subsidy_is_valid_for_historical_blocks() -> Result<(), Report> {
    ...
    subsidy_is_valid_for_network(Network::public_testnet())?;
...
fn funding_stream_validation() -> Result<(), Report> {
    ...
    funding_stream_validation_for_network(Network::public_testnet())?;
...
fn miner_fees_validation_success() -> Result<(), Report> {
    ...
    miner_fees_validation_for_network(Network::public_testnet())?;
...
fn merkle_root_is_valid() -> Result<(), Report> {
    ...
    merkle_root_is_valid_for_network(Network::public_testnet())?;
    ...
    merkle_root_fake_v5_for_network(Network::public_testnet())?;
...
fn transaction_expiration_height_validation() -> Result<(), Report> {
    ...
    transaction_expiration_height_for_network(Network::public_testnet())?;
